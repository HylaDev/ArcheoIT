...
<body>    
    ...
    <div class="sidebar">
        ...
        <a href="gestionContacts.php" class ="active" title="gestion des contacts"><i class="fa fa-envelope"></i> <span>gestion des contacts</span></a>
            ...
            <tbody>
              ...
              if ($execution->num_rows > 0) {
                ...
                while($row = $execution->fetch_assoc()) {
                  ...
                  echo "<td>".$row["body"]."</td>";
                  echo "<td><a href='suppressionContact.php?id=".$row["id"]."' class='btn btn-danger'><i class='fa fa-trash'></i></a></td>";
                  echo "</tr>";
                }
              } else {
                  echo "<tr><td colspan='8'>Aucune demande de contact.</td></tr>";
              }
